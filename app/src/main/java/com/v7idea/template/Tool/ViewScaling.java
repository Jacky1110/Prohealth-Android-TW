...
public class ViewScaling {
    ...
    private static final int defaultHeight = 1334;
...
//    }
    ...
    public static void setImageView(ImageView view) {
        ...
        if (viewLayoutParams != null) {
            ...
            view.setMaxWidth(ViewScaling.getScreenWidth());//預防萬一用的
    ...
    public static void setImageView(ImageView view, int hight) {
        ViewGroup.LayoutParams viewLayoutParams = view.getLayoutParams();
        if (viewLayoutParams != null) {
            view.setAdjustViewBounds(true);
            view.setScaleType(ImageView.ScaleType.CENTER_CROP);
            view.setMaxHeight(hight);//預防萬一用的
            viewLayoutParams.width = ViewGroup.LayoutParams.WRAP_CONTENT;
            viewLayoutParams.height = ViewGroup.LayoutParams.WRAP_CONTENT;
            view.setLayoutParams(viewLayoutParams);
        }
    }
    public static void setImageView(ImageView view, int width, int hight) {
        ViewGroup.LayoutParams viewLayoutParams = view.getLayoutParams();
        if (viewLayoutParams != null) {
            view.setAdjustViewBounds(true);
            view.setScaleType(ImageView.ScaleType.CENTER_CROP);
    ...
    public static void setScaleByRecyclerView(View view) {
    ...
    public static void setScaleForLinearLayout(View view, int width, int height, int top, int left) {
        LinearLayout.LayoutParams viewUse = (LinearLayout.LayoutParams) view.getLayoutParams();
    ...
    public static void setScale(View view, int width, int height, int top, int left) {
        RelativeLayout.LayoutParams viewUse = (RelativeLayout.LayoutParams) view.getLayoutParams();
     ...
     * @param height
     */
    public void setScaleByTableRow(View view, int width, int height) {
        TableRow.LayoutParams viewParams = getTableLayoutParams(view, width, height);
        view.setLayoutParams(viewParams);
    }

    /**
     * 對TableRow內的View調整大小與座標
     *
     * @param view
     * @param width
     * @param height
     ...
     * @param left
     */
    public void setScaleByTableRow(View view, int width, int height, int top, int left) {
        TableRow.LayoutParams viewParams = getTableLayoutParams(view, width, height);
        viewParams.topMargin = top;
        viewParams.leftMargin = left;
        view.setLayoutParams(viewParams);
     ...
     * @return
     */
    private TableRow.LayoutParams getTableLayoutParams(View view, int width, int height) {
        TableRow.LayoutParams viewParams = (TableRow.LayoutParams) view.getLayoutParams();

        if (viewParams == null) {
            viewParams = new TableRow.LayoutParams(width, height);
        } else {
            viewParams.width = width;
            viewParams.height = height;
        }
