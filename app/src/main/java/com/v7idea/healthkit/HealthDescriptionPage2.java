...
/**
 * 2019/1/24 ＊確認使用的頁面 系統設定-立即改善說明2
 */
public class HealthDescriptionPage2 extends BaseActivity
{
    private static final String TAG = "HealthDescriptionPage2";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_health_description_page2);
        ...
        Banner banner = (Banner) ViewScaling.findViewByIdAndScale(currentActivity, R.id.HealthDescriptionPage2_Banner_Header);
        ...
        AutoReleaseImageView AutoReleaseImageView = (AutoReleaseImageView) ViewScaling.findViewByIdAndScale(currentActivity, R.id.HealthDescriptionPage2_AutoReleaseImageView);


        LinearLayout CheckBoxContainer = (LinearLayout) ViewScaling.findViewByIdAndScale(currentActivity, R.id.HealthDescriptionPage2_LinearLayout_CheckBoxContainer);
        CheckIcon = (ImageView) ViewScaling.findViewByIdAndScale(currentActivity, R.id.HealthDescriptionPage2_ImageView_CheckIcon);
        textView = (TextView) ViewScaling.findViewByIdAndScale(currentActivity, R.id.HealthDescriptionPage2_TextView_MiddleTitle);
        TextView CheckBoxHint = (TextView) ViewScaling.findViewByIdAndScale(currentActivity, R.id.HealthDescriptionPage2_TextView_CheckBoxHint);
        ...
        BottomButton BottomButton = (BottomButton) ViewScaling.findViewByIdAndScale(currentActivity, R.id.HealthDescriptionPage2_BottomButton);
        ...
        {
            BottomButton.setData("閱讀立即改善", 100);
            V7TitleView NextPage = BottomButton.getOneButton();
    ...
    View.OnClickListener OnNextPage = new View.OnClickListener()
    {
        ...
        public void onClick(View v)
        {
            ...
            simpleDatabase.setValueByKey(Constant.IS_NOT_HEALTH_REPORT, CheckIcon.isSelected());
